...
int BaseFrame1609_4::getSenderID() const
{
    return this->senderID;
}

void BaseFrame1609_4::setSenderID(int senderID)
{
    this->senderID = senderID;
}

::omnetpp::simtime_t BaseFrame1609_4::getTimestamp() const
{
...
void BaseFrame1609_4::setPayload(const char * payload)
{
