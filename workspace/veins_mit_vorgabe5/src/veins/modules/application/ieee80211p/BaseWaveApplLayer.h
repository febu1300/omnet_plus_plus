...
protected:
    ...
    /** @brief sets all the necessary fields in the WSM or BSM. */
    virtual void prepareWSM(BaseFrame1609_4* wsm, int lengthBits, ChannelType channelType, int priority, int rcvId, int serial);
